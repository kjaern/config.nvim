...
-- greatest remap ever
-- keeps pasted content in register
...
--  vim.keymap.set('n', '<C-j>', '<cmd>cprev<CR>zz') vim.keymap.set("n", "<leader>k", "<cmd>lnext<CR>zz")
vim.keymap.set("n", "<leader>j", "<cmd>lprev<CR>zz")

vim.keymap.set("v", "<leader>s", [[:%s/\<<C-r><C-w>\>/<C-r><C-w>/gI<Left><Left><Left>]])
vim.keymap.set("n", "<leader>sss", [[:%s/\<<C-r><C-w>\>/<C-r><C-w>/gI<Left><Left><Left>]])
-- next greatest remap ever : asbjornHaland
vim.keymap.set({ "n", "v" }, "<leader>y", [["+y]])
vim.keymap.set("n", "<leader>Y", [["+Y]])
...
vim.keymap.set("n", "<A-l>", "<C-w>5>", { desc = "Increase buffer size" })
vim.keymap.set("n", "<A-h>", "<C-w>5<", { desc = "Decrease buffer size" })
vim.keymap.set("n", "<A-j>", "<C-w>3+", { desc = "Increase buffer size" })
vim.keymap.set("n", "<A-k>", "<C-w>3-", { desc = "Decrease buffer size" })
